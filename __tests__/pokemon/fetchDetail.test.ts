...
function pikachuResponse(
  overrides: Partial<RawSpecies> = {},
): { data: { pokemon_v2_pokemonspecies: RawSpecies[] } } {
    ...
    pokemon_v2_pokemons: [
      {
        ...
        pokemon_v2_pokemoncries: [
          {
            cries: {
              latest: "https://cries/pikachu.ogg",
              legacy: "https://cries/pikachu-old.ogg",
            },
          },
        ],
      },
...
describe("fetchDetail", () => {
  ...
  describe("query", () => {
    it("pide exactamente los campos definidos en el plan", () => {
      ...
      expect(POKEMON_DETAIL_QUERY).toContain(
        "pokemon_v2_pokemonspeciesflavortexts",
      );
